...
Counsel used the twenty-minute total allocation stated in the April 24 notice. Questions focused first on whether a motion that says causation only and assigns mitigation to the jury can provide Rule 50(a) notice of a later fixed mitigation request. The panel asked both counsel to distinguish refinement within one issue from substitution of a separate affirmative defense, and to explain how *Unitherm*, *Price*, and *Wiener* bear on that distinction.
...
Granite Heron defended the district court’s functional same-issue analysis under *Wiener* but confirmed that it relied on no different pre-verdict language. It alternatively agreed that, if the panel applied *Price* to reverse JMOL, the Rule 59 ruling and limited scope should remain and the matter should return for a financial trial rather than immediate restoration of the original award.
