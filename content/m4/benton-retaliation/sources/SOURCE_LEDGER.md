...
Checked on 2026-08-11. This ledger separates official legal authority from the synthetic fact
...
Every record source under `documents/batch-1/` was written for this exercise. Each page advances
...
deposition answer is not silently reconciled with a scorecard. Any batch-2 witness material is not
authored in this boundary and must not be treated as present evidence or as a predetermined ruling.
